...
var AuthenticationContext = (function () {
    ...
    AuthenticationContext.prototype.login = function () {
        ...
        // VIGVU - changed here
        var expectedState = 'project';
        if(this.config.state){
            expectedState=this.config.state;
        }
    ...
    */
    ...
    AuthenticationContext.prototype._renewToken = function (resource, callback, responseType) {
        ...
        // VIGVU - changed here
        var expectedState = 'project'+ '|' + resource;
        if(this.config.state){
            expectedState=this.config.state + '|' + resource;
        }
    ...
    AuthenticationContext.prototype._renewIdToken = function (callback, responseType) {
        ...
        // VIGVU - changed here
        var expectedState = 'project'+ '|' + this.config.clientId;
        if(this.config.state){
            expectedState=this.config.state + '|' + this.config.clientId;
        }
  ...
  */
    ...
    * @ignore
    */
    //Here is the check for state match, with state_login
